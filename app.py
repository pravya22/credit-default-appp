...
if st.session_state.page == "home":
    ...
    with c4:
        ...
        <li>Uses a machine learning model</li>
        <li>Performs real-time classification</li>
    ...
    with c5:
        ...
        <li>The model analyzes the input</li>
...
# ---------------- PREDICTION PAGE ----------------
    ...
    st.caption("Enter the applicant's financial details below.")
    ...
    with c2:
        ...
        util = st.number_input(
            ...
            step=0.01,
            format="%.2f",
            help="Credit used divided by total available unsecured credit."
        )
        ...
        if income == 0:
            ...
            try:
                ...
                if probability < 0.30:
                    risk = "LOW RISK"
                    cls = "low"
                    msg = "Applicant appears financially stable based on the entered data."
                elif probability < 0.60:
                    risk = "MEDIUM RISK"
                    cls = "medium"
                    msg = "Applicant shows moderate default risk. Review recommended."
                else:
                    risk = "HIGH RISK"
                    cls = "high"
                    msg = "Applicant may be likely to default. Strong caution is advised."
